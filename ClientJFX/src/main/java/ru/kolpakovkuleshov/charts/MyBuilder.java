...
public class MyBuilder {
    public static Shape buildOrthonormal(Mapper mapper, Range xrange, int xsteps, Range yrange, int ysteps) {
        return buildOrthonormal(new MyOrthonormalGrid(xrange, xsteps, yrange, ysteps), mapper);
    }

    public static Shape buildOrthonormal(MyOrthonormalGrid grid, Mapper mapper) {
